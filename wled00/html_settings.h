...
const char PAGE_settingsCss[] PROGMEM = R"=====(<style>body{font-family:Verdana,sans-serif;text-align:center;background:#f5f5f5;color:#000;line-height:200%%;margin:0}hr{border-color:#666}a{color:#28f;text-decoration:none}.btn,button{background:#009fe2;color:#000;font-family:Verdana,sans-serif;border:none;display:inline-block;font-size:20px;margin:12px 8px 8px;padding:5px 10px;cursor:pointer;text-decoration:none}.lnk{border:0}button.disabled,button[disabled]{color:#aaa}.helpB{text-align:left;position:absolute;width:60px}input{background:#dbdbdb;color:#000;font-family:Verdana,sans-serif;border:2px solid #009fe2}input:disabled{color:#888}input[type=number]{width:4em;margin:2px}input[type=number].xxl{width:100px}input[type=number].xl{width:85px}input[type=number].l{width:63px}input[type=number].m{width:56px}input[type=number].s{width:49px}input[type=number].xs{width:42px}input[type=checkbox]{transform:scale(1.5);margin-right:10px}select{background:#dbdbdb;color:#000;font-family:Verdana,sans-serif;border:2px solid #009fe2}td{padding:2px}.d5{width:4.5em!important}#toast{opacity:0;background-color:#444;border-radius:5px;bottom:64px;color:#fff;font-size:17px;padding:16px;pointer-events:none;position:fixed;text-align:center;z-index:5;transform:translateX(-50%%);max-width:90%%;left:50%%}#toast.show{opacity:1;background-color:#264;animation:fadein .5s,fadein .5s 2.5s reverse}#toast.error{opacity:1;background-color:#b21;animation:fadein .5s}</style>)=====";


// Autogenerated from wled00/data/settings.htm, do not edit!!
const char PAGE_settings[] PROGMEM = R"=====(<!DOCTYPE html><html lang="en"><head><meta charset="UTF-8"><title>WLED Settings
</title><style>
body{text-align:center;background:#f5f5f5;height:100px;margin:0}html{--h:8.9vh}button{background:#dbdbdb;color:#009fe2;font-family:Verdana,Helvetica,sans-serif;border:1px solid #333;border-radius:.5em;font-size:6.5vmin;height:var(--h);width:calc(100%% - 40px);margin-top:2vh}
...
User Interface</button></form>%DMXMENU%<form action="/settings/sync"><button 
...
<button type="submit">Usermods</button></form><form action="/settings/sec">
...
style="position:sticky;top:0;z-index:1"><div class="helpB"><button 
type="button" onclick="H()">?</button></div><button type="button" onclick="B()">
...
href="https://github.com/atuline/WLED/wiki/Macros#analog-button" 
